...
class CookieMonster extends Widget
{
     ...
     * buttonParams:    array parameters to be applied to the buttonMessage as in Yii::t() $params, default []
     ...
     * mainParams:      array parameters to be applied to the mainMessage as in Yii::t() $params, default []
     */
    public $content = [];
    ...
    /**
     * @var mixed parameter or parameters passed to the custom user's view in case this is necessary
     */
    public $params;

    /**
     * @var array list of button HTML options
     */
    protected $buttonHtml = [];
    
    /**
     * @var array list of button CSS styles
     */
    ...
    protected function initCookie()
    {
        ...
        $cookieOptions = Json::encode($cookieOptions);
    ...
    public function run()
    {
        ...
        return $this->render($this->mode == 'custom' ? $this->cookieView : 'box', $this->prepareViewParams());
    }
    ...
    {
        if (!isset($this->contentOptions['category']) || (isset($this->contentOptions['category']) && empty($this->contentOptions['category']))) {
